...
public class Convert {
	public static final String bytesToString(byte[] byts, int nBeginPos)
    {
    	String str="";
		int iLen=0;
		for(iLen=nBeginPos; iLen<byts.length; iLen++){
			if(byts[iLen]==(byte)0) break;
		}		
		if(iLen==nBeginPos) str="";
		else
			try {
				str=new String(byts,nBeginPos,iLen-nBeginPos, "UTF-8");
