...
import com.bairock.zhongchuan.qz.view.activity.map.OfflinePagerAdapter;

import java.util.ArrayList;
import java.util.List;

public class OfflineMapActivity extends AppCompatActivity implements
        OfflineMapManager.OfflineMapDownloadListener, View.OnClickListener, ViewPager.OnPageChangeListener, OfflineMapManager.OfflineLoadedListener {
