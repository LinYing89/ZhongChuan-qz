...
public class WFRender implements Renderer
{
  ...
  public WFRender(GLSurfaceView paramGLSurfaceView)
  {
  ...
  public long createShaders()
  {
    ...
    if (arrayOfInt[0] == 0) destroyShaders();
  ...
  public void onDrawFrame(GL10 gl)
  {
	  ...
	  synchronized (this) {
		 if ((this.mWidth == 0) || (this.mHeight == 0) || (this.mYByteBuffer == null) || (this.mUByteBuffer == null) || (this.mVByteBuffer == null))
			 return;
		 draw(this.mYByteBuffer, this.mUByteBuffer, this.mVByteBuffer, this.mWidth, this.mHeight, gl);
	  }
  }
  public int draw(ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2, ByteBuffer paramByteBuffer3, int paramInt1, int paramInt2, GL10 gl)
  {
    GLES20.glClear(16384);
  ...
  {
    if(this.positionBuffer != null) this.positionBuffer = null;
    return 0;
  }
